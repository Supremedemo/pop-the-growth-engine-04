...
const PredefinedTemplatesPage = () => {
  ...
  const templates = predefinedTemplates.filter(
    ...
    <div className="min-h-screen w-full bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col md:flex-row gap-2">
        ...
        <section className="w-full md:w-1/4 bg-white border-r min-h-full overflow-y-auto p-4">
          <h3 className="font-semibold mb-2 text-slate-800 text-xs uppercase tracking-wide">Templates</h3>
            ...
            {templates.map((tpl) => (
              ...
              >
                <div className="flex gap-3 items-center">
                  <div className="bg-slate-100 rounded-full w-8 h-8 flex items-center justify-center text-slate-400">
                    {/* TODO: Icon */}
